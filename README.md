...
- Onyx Agent tool descriptions and prompts have been patched to describe an additional SymPy package, reinforce correct image link creation from python-generated charts and graphs, and describe network access in coding environments when it is enabled. Generated image markdown is also normalized to portable same-origin links, in case the agent reverts to generic markdown image links.
